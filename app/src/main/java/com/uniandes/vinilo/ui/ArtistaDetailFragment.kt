...
class ArtistaDetailFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val args: ArtistaDetailFragmentArgs  by navArgs()
        viewModel = ViewModelProvider(this, ArtistaDetailViewModel.Factory(activity.application, args.artistaId, args.artistaType))[ArtistaDetailViewModel::class.java]
